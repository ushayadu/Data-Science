In this project for the given amazon food review dataset ,performed t-SNE visualization on the reviews(positive or negative) and check whether its is clearly separable or not :
